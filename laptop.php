...
<header id="header"><!--header-->
				...
				<div class="row">
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							...
							<li><a href="index.php" class="active">Домашня сторінка</a></li>
								<li><a href="about.html">Про нас</a></li>
								<li><a href="contact-us.html">Контакти</a></li>
								<li><a href="404.html">Кошик</a></li>
								<li><a href="login.php">Реєстрація</a></li>
							</ul>
						</div>
					</div>
				</div>
    ...
    <div class="col-sm-9 padding-right">
			...
			<table width="100%">
				<tr><td align="right">
				<label for="filter">Пошук</label> <input type="text" name="filter" value="" id="filter" />
...
$conn = mysqli_connect('localhost','root','','dbgadget');
				...
				{
				$result = mysqli_query($conn, "SELECT * FROM products  where Category='Ноутбуки'");
				...
				$prodID = $row["ID"];	
					...
					<img src="reservation/img/products/'.$row['imgUrl'].'" alt="'.$row['Product'].'" title="'.$row['Product'].'" width="210" height="170" />
                    </a>
